...
public:
    ...
    void setStackChangeCallback(std::function<void(bool,QList<Object>&)> cb) {stackChangeCallback_ = cb;};
...
private:
    ...
    std::function<void(bool,QList<Object>&)> stackChangeCallback_;          // 切换stackwidget页面的回调
};
