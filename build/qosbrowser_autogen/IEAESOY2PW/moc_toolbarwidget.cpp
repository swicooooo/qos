...
#include <memory>
#include "../../../src/uimain/toolbarwidget.h"
...
QT_MOC_LITERAL(1, 14, 11), // "buttonClick"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 2) // "id"

    },
    "ToolBarWidget\0buttonClick\0\0id"
};
...
void ToolBarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ToolBarWidget::buttonClick)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ToolBarWidget::buttonClick(int _t1)
{
