/********************************************************************************
** Form generated from reading UI file 'objectstablewidget.ui'
**
...
#ifndef UI_OBJECTSTABLEWIDGET_H
#define UI_OBJECTSTABLEWIDGET_H
...
public:
    ...
    void setupUi(QWidget *ObjectsWidget)
    {
        ...
        widgetBread = new BreadWidget(ObjectsWidget);
        ...
        widgetPage = new PageWidget(ObjectsWidget);
